function ClickWeb() {
    $('.read-one').click(function () {
        ...
        $('.p-text-first').css("width", "80%");
        $('.p-text-first').css("text-algin", "left");
        $('.read-one').hide();
        ...
        $(".button-one").click(function () {
            ...
            $('.p-text-second').css("width", "80%");
            $('.p-text-second').css("padding-top", "5px");
            $(".button-one").hide();
        })
    })
};
