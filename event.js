...
function setServiceDescription(serviceTitle, serviceHtmlDescription, targetElement) {
    changeAllOpacities(targetElement);
    $('.heading-description').text(serviceTitle);
    $('.service-description').html(serviceHtmlDescription);
}

$('#web').mouseover(e => setServiceDescription(
    `Web Development`,
    `<p class="service-description-paragraph">Most of you might not remember, but the software was once shipped physically by discettes and discs and then installed 
...
$('#mobile').mouseover(e => setServiceDescription(
    `Mobile Development`,
    `<p class="service-description-paragraph">What time is it? Correct. You've just looked at your phone to check it. Admit it, we are using our mobile phones everyda 
...
$('#blockchain').mouseover(e => setServiceDescription(
    `Bloсkchain Development`,
    `<p class="service-description-paragraph">Economic models nowadays have become way too complex. Middlemen are everywhere. Validation by authorities. Trust. 
...
$('#consultancy').mouseover(e => setServiceDescription(
    `Consultancy`,
    `<p class="service-description-paragraph">You are already working with an existing software development team? Are they hard to organize? 
