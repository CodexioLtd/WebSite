function ClickWeb() {
    $('#web').click(function () {
        ...
        $('.heading-web').text(`Web Development`);
    })
};
...
function ClickMobile() {
    $('#mobile').click(function () {
        ...
        $('.heading-mobile').text(`Mobile Development`);
        $('.heading-web').hide();
    })
};
...
function ClickBlockchain() {
    $('#blockchain').click(function () {
        ...
        $('.heading-blockchain').text(`Bloсkchain Development`);
        $('.heading-mobile').hide();
    })
};
...
function ClickConsultancy() {
    $('#consultancy').click(function () {
        ...
        $('.heading-consultancy').text(`Consultancy`);
        $('.heading-blockchain').hide();
    })
};
